"resource/UI/FoundGames.res"
{
	...
	"BtnJoinSelected" 	[$WIN32]
	{
		...
		"ypos"					"345"
		"zpos"					"2"
		"wide"					"180"  [($WIN32 || $OSX) && (!$ENGLISH && !$JAPANESE && !$KOREAN && !$KOREANA && !$SCHINESE && !$TCHINESE)]
		"wide"					"120"  [($WIN32 || $OSX) && ($ENGLISH || $JAPANESE || $KOREAN || $KOREANA || $SCHINESE || $TCHINESE)]
		"tall"					"15"
		"autoResize"			"1"
		"pinCorner"				"0"
		"visible"				"0"
	...
	"BtnDownloadSelected" 	[$WIN32]
	{
		...
		"zpos"					"2"
		"wide"					"f0"//full
		"wide"					"235"  [($WIN32 || $OSX) && (!$RUSSIAN && !$ENGLISH && !$JAPANESE && !$KOREAN && !$KOREANA && !$SCHINESE && !$TCHINESE)]
//		"wide"					"165"  [($WIN32 || $OSX) && ($ENGLISH || $RUSSIAN || $JAPANESE || $KOREAN || $KOREANA || $SCHINESE || $TCHINESE)]
		"tall"					"15"
		"autoResize"			"1"
		"pinCorner"				"0"
		"visible"				"0"
