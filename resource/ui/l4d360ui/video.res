"Resource/UI/Video.res"
{
	...
	"DrpAspectRatio"
	{
		...
		"xpos"				"c-205" [$ENGLISH || $RUSSIAN || $JAPANESE || $KOREAN || $KOREANA || $SCHINESE || $TCHINESE]
		"xpos"				"c-280" [!$RUSSIAN && !$ENGLISH && !$JAPANESE && !$KOREAN && !$KOREANA && !$SCHINESE && !$TCHINESE]
		"ypos"				"110"
		"zpos"				"3"
		"wide"				"410" [$ENGLISH || $RUSSIAN || $JAPANESE || $KOREAN || $KOREANA || $SCHINESE || $TCHINESE]
	...
	"IconUseRecommended"
	{
		...
		"xpos"					"c-225" [$ENGLISH || $RUSSIAN || $JAPANESE || $KOREAN || $KOREANA || $SCHINESE || $TCHINESE]
