"Resource/UI/GameSettings_ScavengeEdit.res"
{
	...
	"IconSwitchToTeamVersus"
	{
		"ControlName"			"ImagePanel"
		"fieldName"				"IconSwitchToTeamVersus"
		"xpos"					"c-265"		
		"ypos"					"195"		
		"wide"					"15"		
		"tall"					"15"		
	...
	"BtnSwitchToTeamVersus"
	{
		"ControlName"			"L4D360HybridButton"
		"fieldName"				"BtnSwitchToTeamVersus"
		"xpos"					"c-250"  [$ENGLISH || $RUSSIAN || $JAPANESE || $KOREAN || $KOREANA || $SCHINESE || $TCHINESE]
		"xpos"					"c-298"  [!$RUSSIAN && !$ENGLISH && !$JAPANESE && !$KOREAN && !$KOREANA && !$SCHINESE && !$TCHINESE]
		"ypos"					"195"	
		...
		"navUp"					"DrpServerType"
		"navDown"				"BtnCancel" 
		"labelText"				"#L4D360UI_Lobby_SwitchTo_teamversus"
